...
if __name__ == "__main__":
    ...
    for sym in syms:
        ...
        f = open("data/%s-%s-%ssec.csv" % (sym, start_date, interval), "w")
        ...
        f = open("data/%s-%s-%ssec.csv" % (sym, start_date, interval), "r")
        lines = f.readlines()
        f.close()
        w = open("data/%s-%s-%ssec.csv" % (sym, start_date, interval), "w")
